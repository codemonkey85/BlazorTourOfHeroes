...
public static class HeroesApi
{
    ...
    private async static Task<IResult> GetHeroes(HttpRequest request) => Results.Ok(heroes);

    private async static Task<IResult> GetHero(HttpRequest request, long id) => Results.Ok(heroes.FirstOrDefault(hero => hero.Id == id));

    private async static Task<IResult> CreateHero(HttpRequest request, Hero hero)
    {
    ...
    private async static Task<IResult> UpdateHero(HttpRequest request, Hero hero)
    {
    ...
    private async static Task<IResult> DeleteHero(HttpRequest request, int id)
    {
